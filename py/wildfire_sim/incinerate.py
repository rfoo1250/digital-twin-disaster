# I should try to intergrate it myself first, without fully using ai
...
SLEEP_TIME = 5 # Time to pause between timesteps for interactive visualization

IGNITION_POINT = "random" # Set to "random" or a specific node ID (e.g., 150)
# TODO make it user pointable as well on the map
#      need to get exact coords on the map... 
